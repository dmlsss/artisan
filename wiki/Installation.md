...
If you are using Kaleido feedforward planning, see the [Roast Planner guide](./RoastPlanner.md) for the integrated template/event and thermal-model workflows, export flow, and safety instructions.
For a full index of fork-specific features (planner, Kaleido UX, quick cupping, CLI/interop, setup script), see [ForkFeatureGuide.md](./ForkFeatureGuide.md).
